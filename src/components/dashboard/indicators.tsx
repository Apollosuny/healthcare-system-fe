  ...
  return (
    <div className=''>
      ...
      <div className='flex items-center justify-between mt-3'>
        <div className='min-w-[220px] max-w-[260] rounded-xl bg-white px-4 py-5 flex items-center gap-3'>
        ...
        <div className='min-w-[200px] max-w-[] rounded-xl bg-white px-4 py-5 flex items-center gap-3'>
